...
///Autor:DEK
///Fecha:
///Comentario:Sobrecargar el operador != de manera tal que de verdadero si el objeto que llama tiene valores distintos
///  que el que se recibe como parámetro. Sobrecargar el operador >
...
public:///puede ser accedido tanto dentro como fuera de la clase
    ...
    string meses[12] = { "ENERO", "FEBRERO","MARZO", "ABRIL" };
        ...
        return true;
    }///para probar la sobrecarga de funciones. La clase no tiene nombres de días
///DESTRUCTOR
    ~Fecha() {
